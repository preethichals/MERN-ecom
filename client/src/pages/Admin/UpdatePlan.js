...
function UpdatePlan() {
  ...
  const getSinglePlan = async () => {
    try {
      const { data } = await axios.get(`https://ecommerce-rm2m.onrender.com/api/v1/plan/get-plan/${params.slug}`);
  ...
  const handleUpdatePlan = async (e) => {
    ...
    try {
      ...
      const { data } = axios.put(`https://ecommerce-rm2m.onrender.com/api/v1/plan/update-plan/${id}`, planData);
      if (data?.success) {
  ...
  const handleDeletePlan = async (e) => {
    try {
      ...
      if (answer) {
        const { data } = await axios.delete(`https://ecommerce-rm2m.onrender.com/api/v1/plan/delete-plan/${id}`);
              ...
              <div className="mb-2">
                {sampleimage ? (
                  ...
                  <div className=" text-center">
                    <img
                      src={`https://ecommerce-rm2m.onrender.com/api/v1/plan/plan-sampleimage/${params.slug}`}
